<!DOCTYPE html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    <div class="image">
      <picture><source srcset="/statics/images/Yn74R7NTaI.webp" type="image/webp"> <source srcset="/statics/images/Yn74R7NTaI.jpg" type="image/jpeg"> <img src="/statics/images/Yn74R7NTaI.jpg" alt="Background"></picture>
    </div>
    ...
    <main class="content level">
      ...
      <p>
        Hidden files have been waiting for a long time.<!--robots.txt-->
      </p>
    </main>
    <!-- Google tag (gtag.js) -->
